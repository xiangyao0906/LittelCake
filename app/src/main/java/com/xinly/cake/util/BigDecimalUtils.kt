...
object BigDecimalUtils {
     ...
     */
    @JvmStatic
    fun formatRoundDown(v: Double, point: Int=6): String {
        if (v == 0.00) {
            return "0"
        }
        val b = BigDecimal("$v")
        return b.setScale(point, BigDecimal.ROUND_DOWN).stripTrailingZeros().toPlainString()
    }
     ...
     */
    @JvmStatic
    fun formatRepairAccuracy(v: Double, point: Int = 6): String {
        if (v == 0.00) {
            return "0"
        }
        val pow = 10.0.pow(point.toDouble())

        return ((pow * v).roundToLong()).div(pow).toString()
    }
     ...
     */
    @JvmStatic
    fun formatRepairAccuracyDoble(v: Double, point: Int = 6): Double {
        if (v == 0.00) {
            return 0.00
        }
        val pow = 10.0.pow(point.toDouble())

        return ((pow * v).roundToLong()).div(pow)
    }
     ...
     */
    @JvmStatic
    fun formatRoundHalfDown(v: Double, point: Int): String {
        val b = BigDecimal("$v")
        return b.setScale(point, BigDecimal.ROUND_HALF_DOWN).stripTrailingZeros().toPlainString()
    }
    ...
    fun formatRoundUp(v: Double, point: Int): Double {
        ...
        return nf.parse(v.toString()).toDouble()
    }
     ...
     * @return double
     */
    fun multiply(v1: Double, v2: Int, scale: Int): Double {
        val n1 = BigDecimal(v1.toString())
        val n2 = BigDecimal(v2.toString())
        return n1.multiply(n2).setScale(scale, RoundingMode.HALF_EVEN).toDouble()
    }
     ...
     * @return double
     */
    fun divide(v1: Double, v2: Double, scale: Int = 0): Double {
        val n1 = BigDecimal(v1.toString())
        val n2 = BigDecimal(v2.toString())
